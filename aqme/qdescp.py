...
class qdescp:
    ...
    def get_boltz_n_save_csv(self,destination,qdescp_files,descp_dict,boltz_dir,smarts_targets):
        ...
        _ = self.write_csv_boltz_data(destination, descp_dict['atom_props'])  # CSV full
    ...
    def write_csv_boltz_data(self, destination, atom_props):
        """
    ...
    def morfeus_properties(self,name_initial,atom_props,smarts_targets,xtb_files_props,charge,mult):
        ...
        global_properties_morfeus = calculate_morfeus_descriptors(xtb_files_props['xtb_xyz_path'],self,charge,mult)
